...
uint256 hashGenesisBlock("0xf97b911214842486ec81793dc368ca288fce07d5ff670f45c03cc58ecf706d4d");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 200000); // Vaultcoin: 200K blocks every 8 months

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 30 * 60; // Vaultcoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Vaultcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf97b911214842486ec81793dc368ca288fce07d5ff670f45c03cc58ecf706d4d");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Time to Open the Vault MR Man. Let it begin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1394029191;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2802739;
        ...
        assert(block.hashMerkleRoot == uint256("0xf12244c79d04021e4d72995f240633d43d67cb43f67198d031caea515af4d386"));
...
unsigned char pchMessageStart[4] = { 0xeb, 0xd0, 0xc6, 0xeb }; // Vaultcoin: increase each by adding 2 to bitcoin's value.
